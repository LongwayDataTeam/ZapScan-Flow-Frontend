...
const AddProductModal: React.FC<AddProductModalProps> = ({ isOpen, onClose }) => {
  const { addProduct, getProductByGCode, getProductByEANCode } = useProductStore();
